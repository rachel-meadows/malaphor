...
from profanityfilter import ProfanityFilter as pf
import json
import random
import nltk
import os
...
# URL for GET requests. The following code defines the response when the URL is called.
@app.route('/', methods=['GET', 'POST'])
def testfn():    # GET request
    if request.method == 'GET':
        # serialize and use JSON headers    # POST request
        return jsonify(malaphor)
